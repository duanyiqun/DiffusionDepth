...
class DDIMDepthEstimate_Swin_Bins_ADDHAHIVis(BaseDepthRefine):
    ...
    def __init__(
        ...
        self.hahineck = HAHIHeteroNeck(in_channels=[192, 384, 768, 1536], out_channels=[192, 384, 768, 1536],
    ...
    def forward(self, fp, depth_map, depth_mask, gt_depth_map=None, return_loss=False, **kwargs):
        ...
        # x = self.
        refined_depth_t, refinelist_t= self.pipeline(
        ...
        processes_vis = []
        for mediate_t in refinelist_t:
            processes_vis.append(self.depth_transform.inv_t(mediate_t))
        ...
        output = {'pred': refined_depth, 'pred_init': gt_map_t, 'blur_depth_t': gt_map_t ,
                ...
                'pred_uncertainty': None,
                 'pred_inter': processes_vis, 'weight_map': None,
...
class CNNDDIMPipiline:
    ...
    def __call__(
        ...
        return {'images': image, 'image_list': image_list}
