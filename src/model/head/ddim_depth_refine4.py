...
class DDIMDepthRefine4(BaseDepthRefine):
    ...
    def __init__(
            ...
            return_indices=None,
            depth_transform_cfg=dict(type='DeepDepthTransformWithUpsamplingX4', hidden=16, eps=1e-6),
            **kwargs
    ):
    ...
    def forward(self, fp, depth_map, depth_mask, gt_depth_map=None, return_loss=False, **kwargs):
        ...
        for i in range(len(fp)):
            f = fp[len(fp) - i - 1]
            f = nn.functional.avg_pool2d(f, kernel_size=2, stride=2)
