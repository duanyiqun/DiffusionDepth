...
class DepthEstimate_Swin_Binsformer(BaseDepthRefine):
    ...
    def forward(self, fp, depth_map, depth_mask, gt_depth_map=None, return_loss=False, **kwargs):
        ...
        # discrete_blur_depth = pred_depths[-1]
        ###################################################
        ...
        output = {'pred': depth, 'pred_init': depth, 'blur_depth_t': depth ,
                'ddim_loss': 0, 'gt_map_t': depth, 
