...
from model.diffusers.schedulers.scheduling_ddim_si import DDIMScheduler
from typing import Union, Dict, Tuple, Optional
from .mmbev_base_depth_refine import BaseDepthRefine
from model.ops.depth_transform import DEPTH_TRANSFORM

@HEADS.register_module()
class DDIMDepthRefine2_SchedularSelf(BaseDepthRefine):
...
class CNNDDIMPipiline:
    ...
    def __call__(
        ...
        # set step values
        self.scheduler.set_biased_timesteps(num_inference_steps)
