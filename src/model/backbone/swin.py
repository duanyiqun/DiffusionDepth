...
from model.ops.swin_wrappers import resize
# from ...utils import get_root_logger
# from ..builder import ATTENTION, BACKBONES
from .convert_ckpt import swin_convert
from .utils import PatchEmbedSwin as PatchEmbed
...
class SwinTransformer(BaseModule):
    ...
    def init_weights(self):
        ...
        if self.pretrained is None:
            ...
            print('complete loading with parameters pretrain from {}'.format(self.pretrained))
...
def swin_large_naive_nopretrain():
...
def swin_large_naive_l4w722422k():
    net = SwinTransformer(pretrain_img_size=224,
                 in_channels=3,
                 embed_dims=192,
                 patch_size=4,
...
# dummy place holder
def swin_large_naive_swinlargepreatrain_add():
    net = SwinTransformer(pretrain_img_size=224,
                 in_channels=3,
                 embed_dims=192,
                 patch_size=4,
